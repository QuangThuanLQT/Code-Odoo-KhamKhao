...
odoo.define('vieterp_product.product_tree', function (require) {
    ...
    ListView.include({
        ...
        render_buttons: function ($node) {
            ...
            $('.pr_search_by_range').html('')
            self.$buttons.find('.o_picking_export_overview').remove();
            if (self.model == 'product.product') {
                ...
                if (self.$buttons || self.$buttons[0].getElementsByClassName('o_picking_export_overview').length == 0) {
